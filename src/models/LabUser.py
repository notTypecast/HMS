...
class LabUser(Staff):
    def __init__(self, labuser_id, first_name, last_name, email, birthdate, sex, monthly_salary, day_bitmask, start_time, end_time, speciality, address=None, phone=None):
    ...
    def add(first_name, last_name, email, birthdate, sex, monthly_salary, day_bitmask, start_time, end_time, speciality, address=None, phone=None):
        ...
        labUser = LabUser(c.lastrowid, first_name, last_name, email, birthdate, sex, monthly_salary, day_bitmask, start_time, end_time, speciality, address, phone)
